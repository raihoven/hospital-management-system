...
public class AmirAdilzhanAishaPrescription {
    ...
    public AmirAdilzhanAishaPrescription() {
    }

    public AmirAdilzhanAishaPrescription(String medicationName, String dosage, String instructions, LocalDate issuedDate, AmirAdilzhanAishaPatient AmirAdilzhanAishaPatient, AmirAdilzhanAishaDoctor AmirAdilzhanAishaDoctor) {
